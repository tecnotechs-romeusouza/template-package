/**
 *
 * @abstract Combinação de imagens
 * @author Romeu Souza
 * @category Combinação
*/
...
from skimage.metrics import structura_similarity

def find_difference(image1, image2):
	assert image1.shape == image2.shape, "Specify 2 images with de same shape"
	gray_image1 = rgb2gray(image1)
	gray_image2 = rgb2gray(image2)
	(score, difference_image) = structura_similarity(gray_image1, gray_image2, full=True)
